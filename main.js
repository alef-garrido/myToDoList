...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/module1.js */ \"./src/utils/module1.js\");\n/* harmony import */ var _utils_editing_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/editing.js */ \"./src/utils/editing.js\");\n/* eslint-disable no-restricted-globals */\n/* eslint-disable no-restricted-syntax */\n/* eslint-disable guard-for-in */\n/* eslint-disable radix */\n\n\n\n\nconst bullets = _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Storage.getFromStorage();\n\nwindow.addEventListener('load', _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.renderList(bullets));\n\n// EVENT LISTENERS\n\nconst addTask = document.querySelector('#addTask');\naddTask.addEventListener('submit', (e) => {\n  e.preventDefault();\n  _utils_editing_js__WEBPACK_IMPORTED_MODULE_2__.default.add(bullets);\n  _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Storage.saveToStorage(bullets);\n  _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.renderList(bullets);\n  location.reload();\n});\n\n// Status Update\nconst taskList = document.querySelector('#listContainer');\ntaskList.addEventListener('change', (e) => {\n  if (e.target.classList.contains('status')) {\n    const { id } = e.target.parentElement;\n    const taskBody = document.getElementById(`task-${id}`);\n    _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Status.toggleBullet(bullets, parseInt(id, 10));\n    _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Storage.saveToStorage(bullets);\n    taskBody.classList.toggle('completed');\n    _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Storage.saveToStorage(bullets);\n  }\n});\n\n// Edit Description\nconst inputs = Array.from(document.querySelectorAll('.todo'));\ninputs.forEach((input) => {\n  input.addEventListener('input', (e) => {\n    const id = parseInt(e.target.parentElement.id);\n    const { value } = e.target;\n    _utils_editing_js__WEBPACK_IMPORTED_MODULE_2__.default.updateTask(bullets, id, value);\n    _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Storage.saveToStorage(bullets);\n  });\n});\n\nconst tasks = Array.from(document.querySelectorAll('.todo'));\nfor (const task in tasks) {\n  const id = parseInt(task) + 1;\n  const bulletRow = document.getElementById(`${id}`);\n\n  const trash = document.getElementById(`trash-${id}`);\n  const dots = document.getElementById(`dots-${id}`);\n\n  bulletRow.addEventListener('focusin', () => {\n    bulletRow.classList.toggle('editing');\n    trash.classList.toggle('hide');\n    dots.classList.toggle('hide');\n  });\n  bulletRow.addEventListener('focusout', () => {\n    setTimeout(() => {\n      bulletRow.classList.toggle('editing');\n      trash.classList.toggle('hide');\n      dots.classList.toggle('hide');\n    }, 100);\n  });\n}\n\n// Update id/index\nfunction updateId() {\n  bullets.forEach((task, index) => {\n    task.id = index + 1;\n  });\n  _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Storage.saveToStorage(bullets);\n  _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.renderList(bullets);\n  location.reload();\n}\n\n// Delete task\nconst listContainer = document.getElementById('listContainer');\nlistContainer.addEventListener('click', (e) => {\n  if (e.target.classList.contains('fa-trash-alt')) {\n    const index = parseInt(e.target.parentElement.parentElement.id);\n    _utils_editing_js__WEBPACK_IMPORTED_MODULE_2__.default.deleteTask(bullets, index - 1);\n    updateId();\n  }\n});\n\n// Clear all completed tasks\nconst clearBtn = document.querySelector('.clearBtn');\nclearBtn.addEventListener('click', () => {\n  _utils_editing_js__WEBPACK_IMPORTED_MODULE_2__.default.clearCompleted(bullets);\n  updateId();\n  _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.Storage.saveToStorage(bullets);\n  _utils_module1_js__WEBPACK_IMPORTED_MODULE_1__.renderList(bullets);\n});\n\n\n//# sourceURL=webpack://mytodolist/./src/index.js?");
